...
UNIVERSE = {
    ...
    "MU": ("semiconductor", 130.0, 0.24, 0.036),
    "QCOM": ("semiconductor", 175.0, 0.08, 0.028),
    "MRVL": ("semiconductor", 92.0, 0.18, 0.040),
    "INTC": ("semiconductor", 40.0, -0.12, 0.034),
    "SOXL": ("semiconductor_etf", 42.0, 0.30, 0.060),
    "SOXS": ("semiconductor_etf", 8.2, -0.35, 0.060),
    "SOXX": ("semiconductor_etf", 245.0, 0.26, 0.030),
    ...
    "TSLA": ("big_tech", 340.0, 0.05, 0.045),
    "NFLX": ("big_tech", 900.0, 0.22, 0.026),
    "ORCL": ("big_tech", 190.0, 0.19, 0.024),
    "CRM": ("big_tech", 280.0, 0.09, 0.025),
    "PLTR": ("big_tech", 95.0, 0.30, 0.050),
    "QQQ": ("big_tech_etf", 520.0, 0.18, 0.017),
    "JPM": ("financials", 280.0, 0.14, 0.018),
    "BAC": ("financials", 48.0, 0.10, 0.020),
    "GS": ("financials", 620.0, 0.16, 0.022),
    "MS": ("financials", 140.0, 0.12, 0.021),
    "WFC": ("financials", 78.0, 0.11, 0.021),
    "XOM": ("energy", 118.0, 0.06, 0.019),
    "CVX": ("energy", 165.0, 0.05, 0.019),
    "COP": ("energy", 105.0, 0.04, 0.024),
    "SLB": ("energy", 44.0, -0.05, 0.028),
}
